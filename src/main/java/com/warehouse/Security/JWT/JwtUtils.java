package com.warehouse.Security.JWT;
...
import com.warehouse.Security.ServiceSecurity.UserDetailsServiceImpl;
...
public class JwtUtils {
    ...
    public ResponseCookie ganrateJwtCookie(UserDetaileImpl userDetails)  {
        String jwt=ganrateTokenFromUsername(userDetails.getUsername());
